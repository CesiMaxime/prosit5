...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->txt_source->Size = System::Drawing::Size(307, 26);
			...
			this->txt_destination->Size = System::Drawing::Size(307, 26);
			this->txt_destination->TabIndex = 9;
			
			// 
			// rdb_effacer
			// 
			this->rdb_effacer->Location = System::Drawing::Point(0, 0);
			this->rdb_effacer->Name = L"rdb_effacer";
			this->rdb_effacer->Size = System::Drawing::Size(104, 24);
			this->rdb_effacer->TabIndex = 0;
			// 
			// rdb_coiperEffacer
			// 
			this->rdb_coiperEffacer->Location = System::Drawing::Point(0, 0);
			this->rdb_coiperEffacer->Name = L"rdb_coiperEffacer";
			this->rdb_coiperEffacer->Size = System::Drawing::Size(104, 24);
			this->rdb_coiperEffacer->TabIndex = 1;
			// 
			// rdb_copier
			// 
			this->rdb_copier->Location = System::Drawing::Point(0, 0);
			this->rdb_copier->Name = L"rdb_copier";
			this->rdb_copier->Size = System::Drawing::Size(104, 24);
			this->rdb_copier->TabIndex = 2;

			// 
			// btn_proceder
			// 
			this->btn_proceder->Location = System::Drawing::Point(0, 0);
			this->btn_proceder->Name = L"btn_proceder";
			this->btn_proceder->Size = System::Drawing::Size(75, 23);
			this->btn_proceder->TabIndex = 0;
			// 
			// txt_rslt
			// 
			this->txt_rslt->Location = System::Drawing::Point(0, 0);
			this->txt_rslt->Name = L"txt_rslt";
			this->txt_rslt->Size = System::Drawing::Size(100, 26);
			this->txt_rslt->TabIndex = 0;

			// 
			// lbl_resultats
			// 
			this->lbl_resultats->Location = System::Drawing::Point(0, 0);
			this->lbl_resultats->Name = L"lbl_resultats";
			this->lbl_resultats->Size = System::Drawing::Size(100, 23);
			this->lbl_resultats->TabIndex = 0;
			// 
			// gpBox_typeProcessus
			// 
